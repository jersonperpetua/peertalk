...
- (void)connectToPort:(int)port overUSBHub:(PTUSBHub*)usbHub deviceID:(NSNumber*)deviceID callback:(nullable void(^)(NSError *error))callback;
...
- (void)connectToPort:(in_port_t)port IPv4Address:(in_addr_t)address callback:(nullable void(^)(NSError *error, PTAddress *address))callback;
...
- (void)listenOnPort:(in_port_t)port IPv4Address:(in_addr_t)address callback:(nullable void(^)(NSError *error))callback;
...
- (void)sendFrameOfType:(PTFrameType)frameType tag:(PTFrameTag)tag withPayload:(nullable dispatch_data_t)payload callback:(nullable void(^)(NSError *error))callback;
