...
- (void)connectToPort:(int)port overUSBHub:(PTUSBHub*)usbHub deviceID:(NSNumber*)deviceID callback:(nullable void(^)(NSError * _Nullable error))callback;
...
- (void)connectToPort:(in_port_t)port IPv4Address:(in_addr_t)address callback:(nullable void(^)(NSError * _Nullable error, PTAddress *address))callback;
...
- (void)listenOnPort:(in_port_t)port IPv4Address:(in_addr_t)address callback:(nullable void(^)(NSError * _Nullable error))callback;
...
- (void)sendFrameOfType:(PTFrameType)frameType tag:(PTFrameTag)tag withPayload:(nullable dispatch_data_t)payload callback:(nullable void(^)(NSError * _Nullable error))callback;
...
- (void)ioFrameChannel:(PTChannel*)channel didReceiveFrameOfType:(PTFrameType)type tag:(PTFrameTag)tag payload:(nullable PTData*)payload;
...
- (void)ioFrameChannel:(PTChannel*)channel didEndWithError:(nullable NSError*)error;
